...
```
```{figure} /_static/pythonblock/ru/dicts_l7/Python-Immutable-Example-1.png
...
```{figure} /_static/pythonblock/ru/dicts_l7/Python-Immutable-Example-2.png
...
```{figure} /_static/pythonblock/ru/dicts_l7/Python-Mutable-Example.png
...
```{figure} /_static/pythonblock/ru/dicts_l7/Python-Mutable-Example-2.png
