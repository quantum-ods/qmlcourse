...
```{figure} /_static/python/ru/oop_l10/class_and_obj1.png
:name: class_and_obj1
:width: 250px
...
```{figure} /_static/python/ru/oop_l10/class_and_obj_house.png
...
```{figure} /_static/python/ru/oop_l10/class_and_obj_pika.png
