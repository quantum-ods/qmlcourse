...
```{figure} /_static/hwblock/ru/Yb171+_energy_levels.png
...
```{figure} /_static/hwblock/ru/cropatom-800x603.jpg
:name: single atom
:width: 666px
...
```{figure} /_static/hwblock/ru/silicon-qubits.png
:name: silicon qubits
...
```{figure} /_static/hwblock/ru/ions-computation-schematic.png
...
```{figure} /_static/hwblock/ru/xanadu.png
