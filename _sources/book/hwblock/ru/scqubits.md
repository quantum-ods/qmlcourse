...
```{figure} /_static/hwblock/ru/two-qubit-chip.png
...
```{figure} /_static/hwblock/ru/LC.png
:name: LC circuit
:width: 550px
...
```{figure} /_static/hwblock/ru/Transmon.png
...
```{figure} /_static/hwblock/ru/transmon-wavefunctions.png
...
```{figure} /_static/hwblock/ru/cpb-dispersion.png
...
```{figure} /_static/hwblock/ru/cQED.png
...
```{figure} /_static/hwblock/ru/avg_cov.png
...
```{figure} /_static/hwblock/ru/external-drive.png
...
```{figure} /_static/hwblock/ru/decoherence.png
...
```{figure} /_static/hwblock/ru/benchmarking-result.png
...
```{figure} /_static/hwblock/ru/two-qubit-pulse-sequence-parametric.png
