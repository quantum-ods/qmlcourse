...
Не зря так глубоко изучали [модель Изинга](ising) и [анализировали](advising) ее решения -- сегодня увидим, как в терминах этой модели можно сформулировать большинство важных задач [комбинаторной оптимизации](copt).

## QUBO матрица

Но сначала кратко обсудим так называемую `QUBO` матрицу {cite}`glover2019tutorial` -- это еще один способ записать задачу модель Изинга и дальше по курсу иногда будем этим пользоваться.
