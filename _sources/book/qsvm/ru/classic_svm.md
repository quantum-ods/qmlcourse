...
```{figure} /_static/qsvm/ru/lin_classifier.png
:width: 350px
:name: lin_classifier
...
```{figure} /_static/qsvm/ru/distance_to_the_plane.png
:width: 400px
...
```{figure} /_static/qsvm/ru/margin_toy_example.png
:width: 400px
...
```{figure} /_static/qsvm/ru/linclass_margins.png
:width: 450px
...
```{figure} /_static/qsvm/ru/loss_functions_logistic_and_hinge.png
:width: 450px
...
```{figure} /_static/qsvm/ru/kernel_trick_idea.png
:width: 600px
:name: KernelTrick
