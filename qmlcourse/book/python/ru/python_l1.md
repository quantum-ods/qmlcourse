...
Если у вас есть опыт программирования на `Python`, рекомендуем ознакомиться [с пререквизитами курса](../../intro/ru/prerequisite.md) -- так вы сможете понять, какие разделы стоит изучить или освежить в памяти перед прохождением курса. Тест можно игнорировать, если вы только начинаете свое знакомство с `Python`.
