...
```{figure} /_static/hw/ru/two-qubit-chip.png
...
```{figure} /_static/hw/ru/Transmon.png
...
```{figure} /_static/hw/ru/cpb-dispersion.png
...
```{figure} /_static/hw/ru/avg_cov.png
...
```{figure} /_static/hw/ru/external-drive.png
...
```{figure} /_static/hw/ru/decoherence.png
...
```{figure} /_static/hw/ru/benchmarking-result.png
...
```{figure} /_static/hw/ru/two-qubit-pulse-sequence-parametric.png
