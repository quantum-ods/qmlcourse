...
```{figure} /_static/qmlkinds/ru/hhl_algorithm/614px-Seth_Lloyd.jpg
:name: lloyd
:width: 350px
...
```{figure} /_static/qmlkinds/ru/hhl_algorithm/hhl_circuit.png
:name: hhl_curcuit
:width: 800px
...
```{figure} /_static/qmlkinds/ru/hhl_algorithm/hhl_circuit2.png
:name: hhl_curcuit2
:width: 800px
