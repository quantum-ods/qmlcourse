...
```{figure} /_static/dwaveblock/ru/dwave/fig_3.png
:name: fig_1
:width: 444px
...
```{figure} /_static/dwaveblock/ru/dwave/fig_1.png
:name: fig_2
:width: 444px
...
```{figure} /_static/qaoablock/ru/hamiltonian_u_phase.png
...
```{figure} /_static/qaoablock/ru/general_scheme_for_n_qubits.png
...
2. последующее применение к каждому кубиту матриц Адамара для осуществления суперпозиции всевозможных состояний
    ...
    ```{figure} /_static/qaoablock/ru/the_1t_step_alg.png
...
3. применяем оператор вращения фазы
    ...
    ```{figure} /_static/qaoablock/ru/the_2d_step_alg.png
...
4. применяем смешивающий оператор
    ...
    ```{figure} /_static/qaoablock/ru/the_3d_step_alg.png
...
```{figure} /_static/qaoablock/ru/ansatz_mixing.png
:name: ansatz_mixing
:width: 444px
...
```{figure} /_static/qaoablock/ru/ansatz_operator_designation.png
...
```{figure} /_static/qaoablock/ru/ansats_types.png
:name: ansatz_types
:width: 444px
```
...
```{figure} /_static/qaoablock/ru/ansatz_sample.png
:name: ansatz_sample
:width: 444px
```
