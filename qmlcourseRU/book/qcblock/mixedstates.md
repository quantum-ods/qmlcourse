...
В квантовой механике существует также численная характеристика того, насколько сильно наша система "запутанная". Эта величина называется энтропией фон-Неймана, а ее выражение очень похоже на выражение для классической [энтропии Шеннона](https://ru.wikipedia.org/wiki/Информационная_энтропия). Только в отличии от классики, в квантовой механике мы имеем _матрицу_ плотности, поэтому в выражении у нас фигурирует _матричный логарифм_:
