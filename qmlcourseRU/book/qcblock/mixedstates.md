...
_запутыванием_ (англ. entanglement), а сами состояния _запутанными_ (англ. _entangled_).
...
Разложение Шмидта
Число Шмидта, (степень) чистота состояния (= линейная энтропия) - примеры для кубита и в общем случае (?)
Энтропия Шеннона
