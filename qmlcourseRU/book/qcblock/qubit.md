...
интерференцию и дифракцию), и свойства частиц -- например, всегдя есть минимальная порция (`квант`!) света или электричества. Кстати, часто вместо вектора состояния
