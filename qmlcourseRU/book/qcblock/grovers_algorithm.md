...
В общем случае этот угол равен $(2i + 1) \theta$, где $i$ - номер произведенной итерации. Отсюда можно вывести число итераций, необходимое для работы алгоритма: это приблизительно $\frac{\pi \sqrt{N}}{4}$ при стремлении $\theta$ к $0$.
