...
Так как в качестве искомого индекса выступало значение $11$, то в результате запуска функции мы должны получить два собственных значения матрицы паули $Z$. Оба этих значения должны быть равны $-1$, то есть они соответсвуют состоянию $11$. Таким образом, мы нашли с помощью алгоритма Гровера искомый индекс.
