...
Стартуем мы со следующим состонием:

$$|0\rangle_{a}|0\rangle_{r}|b\rangle_{m}$$
...
Шаг 2. Дело осталось за малым. Поворачиваем первый кубит все лямбды и вернуть им вероятностную, а не векторную форму. За это отвечает специальный оператор вращения $R$:
