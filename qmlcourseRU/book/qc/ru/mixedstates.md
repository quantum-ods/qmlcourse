...
Квантовая механика работает так, что любое [измерение](../qc/qubit.html#id23) приводит к коллапсу волновой функции
...
(подробнее об этом было в [лекции про кубит](../qc/qubit.html#id31)).
