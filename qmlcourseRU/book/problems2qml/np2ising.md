...
Для нас удобно, что это уже задача минимизации.
...
Из этой лекции мы узнали, что такое _QUBO_ матрица, а также как от такой формулировки оптимизационных задач можно перейти к задаче поиска основного состояния кванто-механической системы. В будущих лекциях мы познакомимся уже непосредственно с методами решения это задачи на квантовых компьютерах.
