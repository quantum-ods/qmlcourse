...
Объединив модульности в уравнении {eq}`eqn:comdet_5` и штрафной гамильтониан в уравнении {eq}`eqn:comdet_7`, получаем окончательный `QUBO`-гамильтониан для общего обнаружения сообщества с $k$ классами
