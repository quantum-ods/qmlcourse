...
```{figure} /_static/qnnblock/ru/qugan.png
:name: qugan
:width: 700px
...
```{figure} /_static/qnnblock/ru/molgan.png
:name: molgan
:width: 700px
...
```{figure} /_static/qnnblock/ru/qnntfq2.png
:name: qnn
:width: 700px
...
```{figure} /_static/qnnblock/ru/layer_cvqnn.png
:name: ansatz
:width: 800px
...
```{figure} /_static/qnnblock/ru/qnngrads.png
:name: grads
:height: 400px
