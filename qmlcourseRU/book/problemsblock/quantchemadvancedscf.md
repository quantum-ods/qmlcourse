...
В целом, основная задача квантовой химии -- найти ground state произвольной системы частиц. В реальности материя редко находятся непосредственнов в ground state состоянии, т.к. при ненулевой температуре какие-то флуктуации неизбежно возникают. Тем не менее, ground state обычно в наибольшей степени определяет поведение системы, а другие состояния являются "поправками" к нему.
...
Волновая функция $\ket{\Psi_{100}}$ (т.е. с числами $n=1, \ell=0, m=0$) соответствует минимальной энергии для единственного электрона в атоме водрода. Т.к. в атоме водорода есть лишь один электрон, и других вкладов в энергию нет -- весь атом водорода в такой конфигурации имеет минимальную энергию.
