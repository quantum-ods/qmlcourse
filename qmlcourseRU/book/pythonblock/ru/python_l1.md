...
```{figure} /_static/pythonblock/ru/intro_l1/blackhole.png
:name: blackhole
:width: 600px
...
```{figure} /_static/pythonblock/ru/intro_l1/aero_python.png
:name: aero_python
:width: 600px
...
```{figure} /_static/pythonblock/ru/intro_l1/cat_at_the_end.png
:name: cat_at_the_end
:width: 350px
