...
Вспомним один из примеров выше, где мы представляли прямоугольную систему координат на плоскости и единичные векторы (орты) $\mathbf{e}_1$, $\mathbf{e}_2$. В данном примере мы разложили произвольный вектор $\mathbf{a}$ следующим образом:
$$
\mathbf{a} = a_1 \mathbf{e}_1 + a_2 \mathbf{e}_2 = \begin{pmatrix} a_1 \\ a_2 \end{pmatrix}
$$
