...
- [Кашницкий Юрий](https://github.com/alexey-pronkin)
...
```{figure} /_static/mlblock/ru/see_also.png
:width: 600px
:name: see_also
...
```{figure} /_static/mlblock/ru/covid_detection_ct.png
:width: 1000px
...
```{figure} /_static/mlblock/ru/covid_detection_prediction.png
:width: 1000px
...
```{figure} /_static/mlblock/ru/detection_yolo.jpeg
:name: detection_yolo
:width: 800px
...
```{figure} /_static/mlblock/ru/example_styletransfer.png
...
```{figure} /_static/mlblock/ru/object_detection_loss.png
...
```{figure} /_static/mlblock/ru/k_fold_cross_validation.png
