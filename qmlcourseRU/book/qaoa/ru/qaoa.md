...
В прошлых лекция активно [рассказывалось](dwave) о квантовых _аннилерах_ (_отжигателях_, англ. _annealers_) -- аналоговых устройствах, реализующих поиск основного состояния системы. Выпишем еще раз [гамильтониан](../dwave/dwave.html#id4), который там используется:
